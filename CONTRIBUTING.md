...
1.  From your branch, make a pull request against `twitter/.github/master` 
1.  Work with repo maintainers to get your change reviewed 
1.  Wait for your change to be pulled into `twitter/.github/master`
...
docs. Please file an [issue](https://github.com/twitter/.github/issues).

# License 

By contributing your code, you agree to license your contribution under the 
terms of the APLv2: https://github.com/twitter/.github/blob/master/LICENSE
